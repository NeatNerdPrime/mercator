...
| Serveurs logiques                | 1      | !active ou (Description, OS, environnement, adresse IP, applications, serveurs physique ou clusters)   |
| VLans                            | 1      | Description                                                                                            |
...
| Serveurs physique                | 1      | Description, configuration, site, responsable                                                          |
| Poste de travail                 | 1      | Description, site                                                                                      |
| Téléphones                       | 1      | Description, site                                                                                      |
| Stockage                         | 1      | Description, site                                                                                      |
| Périphériques                    | 1      | Description, site, responsable                                                                         |
| Commutateurs physique            | 1      | Description, type, site                                                                                |
| Routeurs physique                | 1      | Description, type, site                                                                                |
| Terminaux WiFi                   | 1      | Description, type, site                                                                                |
| Dispositifs de sécurité physique | 1      | Description, type, site                                                                                |
| LANs                             | 1      | Description                                                                                            |
