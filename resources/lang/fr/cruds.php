...
return [
    ...
    'monarc' => [
        ...
        'sync' => [
            ...
            'anr_select_help' => "C'est aussi le nom de l'analyse. Choisissez une ANR existante dans Monarc pour continuer à la synchroniser — la sélection ci-dessous est restaurée à partir de ce qui lui a déjà été envoyé — ou saisissez un nom qui n'existe pas encore pour en créer une nouvelle. Lier une ANR non créée depuis Mercator peut dupliquer des objets lors de la première synchronisation, car Mercator ne peut pas savoir ce qu'elle contient déjà.",
            'model_label' => "Modèle d'analyse",
            'model_placeholder' => 'Sélectionner un modèle…',
            'model_help' => "Utilisé uniquement lors de la création d'une nouvelle ANR.",
            'last_sync_none' => 'Jamais synchronisé.',
            'last_sync' => 'Dernière synchronisation : :date',
            'synced_count' => 'Objets suivis : :count',
            'create_button' => "Créer / Synchroniser l'ANR",
            'reset_button' => 'Réinitialiser la liaison',
            'reset_confirm_title' => 'Réinitialiser la liaison Monarc ?',
            'reset_confirm_body' => "Ceci oublie la liaison locale avec l'ANR ainsi que tous les objets suivis : la prochaine synchronisation créera une toute nouvelle ANR. L'ANR elle-même n'est pas supprimée dans Monarc.",
            ...
            'errors' => [
                'model_required' => "Sélectionnez un modèle d'analyse avant de créer l'ANR.",
